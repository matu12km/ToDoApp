  ...
  var Pe = (t, e, r, n) => {
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let i of we(e))
        !ke.call(t, i) &&
          i !== r &&
          re(t, i, { get: () => e[i], enumerable: !(n = Se(e, i)) || n.enumerable });
    return t;
  };
  var Ie = (t, e, r) => (
    (r = t != null ? be(Te(t)) : {}),
    Pe(e || !t || !t.__esModule ? re(r, 'default', { value: t, enumerable: !0 }) : r, t)
  );
  var ae = Qe((se, oe) => {
    (function () {
      var t = function (e) {
  ...
  var U = class {
    ...
    ensureActivePageVisible() {
      ...
      for (; r && !r.classList.contains('.tsd-navigation'); )
        r instanceof HTMLDetailsElement && e?.parentElement?.parentElement !== r && (r.open = !0),
          (r = r.parentElement);
      if (e) {
