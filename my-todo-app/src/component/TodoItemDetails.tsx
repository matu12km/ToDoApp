        ...
        >
          <div role='alert' className='container mx-auto w-11/12 md:w-2/3 max-w-lg'>
            <div className='relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400'>
              ...
              <h1 className='text-gray-800 font-lg font-bold tracking-normal leading-tight mb-4'>{task.title}</h1>
              <h2>内容</h2>
              <p className='text-gray-600 text-sm tracking-normal leading-tight mb-4'>{task.content}</p>
              <h2>期限</h2>
              <p className='text-gray-600 text-sm tracking-normal leading-tight mb-4'>
                {task.scheduledDate != undefined && new Date(task.scheduledDate).toISOString().split('T')[0]}
              </p>
              <h2>更新日</h2>
              <p className='text-gray-600 text-sm tracking-normal leading-tight mb-4'>
                {new Date(task.udpatedDate).toISOString().split('T')[0]}
              </p>
              <h2>ステータス</h2>
              <p className='text-gray-600 text-sm tracking-normal leading-tight mb-4'>
